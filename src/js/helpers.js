...
export let ingredientsTags = document.querySelectorAll(`[data-tag-type="ingredient"]`) ;
export let devicesList = document.getElementById("devices-list") ;
export let devicesTags = document.querySelectorAll(`[data-tag-type="device"]`) ;
...
export let utensilTags = document.querySelectorAll(`[data-tag-type="utensil"]`) ;
